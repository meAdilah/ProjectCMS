...
<tr>
<td>
<form action="database/save_to_donation.php" method="post"> 
...
Date of Fund:<br />
<input type="date" name="dateofdonation" size="25" required><br />
<br />

Total Fund(RM):<br />
<input type="text" name="totaldonation" size="25" maxlength="4" required><br />
<br />
 
Reference:<br />
<input type="text" name="receiptnum" size="25" required><br />
<br />
