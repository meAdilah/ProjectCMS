...
<tr>
<td>
<form method="post" action="database/save_to_announce.php" > 

Reference ID:<br />
<input type="text" name="ref" size="25" required><br />
<br />

Date:<br />
<input type="date" name="date" size="25" required><br />
<br />

Title:<br />
<input type="text" name="title" size="75" required><br />
<br />
