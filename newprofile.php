...
Metric ID:<br />
<input type="text" name="metricid" value="<?php echo $metricid;?>" maxlength="7" minlength="7"><br />
<span class="error"> <?php echo $metricidErr;?></span>
<br />
 
Phone Number:<br />
<input type="text" name="phoneno" value="<?php echo $phoneno;?>" maxlength="11" minlength="10"><br />
...
Postcode:<br />
<input type="text" name="postcode" value="<?php echo $postcode;?>" maxlength="5" minlength="5"><br />
